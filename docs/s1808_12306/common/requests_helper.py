...
if __name__ == '__main__':
    text = '''
        random	1542709176082
        tourFlag	dc
        _json_att	
        REPEAT_SUBMIT_TOKEN	074b42468b36744119b23a5649f1d3c0
    '''

    # 将 charles中复制的 headers 格式化输出为一个 dict
    print_dict_from_copy_headers(text)

    # url_params = 'callback=jQuery1910292836177545567_1542355491387&answer=269%2C40&rand=sjrand&login_site=E&_=1542355491389'
