#!/usr/bin/env python
# -*- coding: utf-8 -*-
from docs.s1121.selenium_huxiu.img_handle import get_diff_location, get_image
...
class GeettestHuXiu(object):
    ...
    def __create_driver(self):
        # options = webdriver.Chrome.create_options()
    ...
    def visit(self):
        ...
        # 找到 注册按钮
        reg = self.driver.find_element_by_xpath('//a[@class="js-register"]')
        # 点击注册按钮
        reg.click()
